...
int main(int argc, char *argv[])
{
    ...
    engine.load(QUrl(parser.isSet(qmlrootfileOption) ? parser.value(qmlrootfileOption) : parser.isSet(requestGoogleCredentialsOption) ? QStringLiteral("qrc:/qml/RequestGoogleCredentials.qml") : QStringLiteral("qrc:/qml/main.qml")));
