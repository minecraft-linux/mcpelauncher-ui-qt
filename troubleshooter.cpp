...
QList<QObject*> Troubleshooter::findIssues() {
    ...
    if (versionInfo["SSSE3 support"] != "YES")
        ret.append((new TroubleshooterIssue(TroubleshooterIssue::TYPE_LAUNCHER_SOFTWARE_RENDERER, "No CPU SSSE3 support", "Your CPU may be unsupported and the game may crash on startup."))
