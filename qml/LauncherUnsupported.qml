...
ColumnLayout {
    ...
    TextEdit {
        ...
        text: "<b><font color=\"#ff0000\">Sorry your Computer cannot run Minecraft with this Launcher</font></b>, this CPU is too old.<br/>Details:<br/>" + googleLoginHelper.GetSupportReport()
        readOnly: true
    ...
    Image {
        ...
        RowLayout {
            ...
            PlayButton {
                ...
                subText: "I don't expect any support"
